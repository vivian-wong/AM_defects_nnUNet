...
from nnunet.network_architecture.vnet import VNet
...
class VNetTrainer(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = VNet(self.num_input_channels, self.base_num_features, self.num_classes,
